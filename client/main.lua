				...
				if IsPedInAnyVehicle(PlayerPedId(), false) then
					...
					for i = 1,20 do 
						if DoesExtraExist(GetVehiclePedIsIn(PlayerPedId(), 0), i) then
							RageUI.Checkbox("Extra "..i, "Permet d'ajoutée des extrat", IsVehicleExtraTurnedOn(GetVehiclePedIsIn(PlayerPedId(), 0), i), { Style = RageUI.CheckboxStyle.Tick }, function(Hovered, Selected, Active, Checked)
							end, function()
